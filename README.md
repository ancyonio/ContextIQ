...
[![Docs](https://img.shields.io/badge/docs-contextiq.github.io-3c8772)](https://contextiq.github.io/contextiq/)

📖 **[Read the docs →](https://contextiq.github.io/contextiq/)** &nbsp;·&nbsp; [Quick start](guide/quick-start.md) &nbsp;·&nbsp; [CLI reference](guide/cli.md) &nbsp;·&nbsp; [When to use what](guide/when-to-use.md)
